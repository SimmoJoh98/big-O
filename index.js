...
// ANSWER:
//I don't see a reason to change it up. Count === 4 will stop the loop anyways.
...
// ANSWER:
function convertSquared(numbers){
  let result = []
  for(let i = 0; i < numbers.length; i++){
...
// ANSWER: 
//each function takes in str, and it just depends on the length of the string at that point.